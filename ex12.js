...
// You've managed to flatten a tree that's two levels deep, let's try for three! Let's say that instead of a single boxart
//  url on each video, we had a collection of boxart objects, each with a different size and url.
